...
const SEASON_DATA = {
  ...
  "Stagione 4": {
    ...
    calendar: [
      { round: 1, race: "Qatar GP",          city: "Lusail",            status: "undone",     winner: "...", raceKey: "..."  },
      { round: 2, race: "Japan GP",          city: "Suzuka",            status: "undone",     winner: "...", raceKey: "..."  },
      { round: 3, race: "Australian GP",     city: "Melbourne",         status: "undone",     winner: "...", raceKey: "..."  },
      { round: 4, race: "Saudi Arabian GP",  city: "Jeddah",            status: "undone",     winner: "...", raceKey: "..."  },
      { round: 5, race: "Austrian GP",       city: "Red Bull Ring",     status: "undone",     winner: "...", raceKey: "..."  },
      { round: 6, race: "Belgium GP",        city: "Spa-Francochamps",  status: "undone",     winner: "...", raceKey: "..."  },
      { round: 7, race: "São Paulo GP",      city: "São Paulo",         status: "undone",     winner: "...", raceKey: "..."  },
    ],
