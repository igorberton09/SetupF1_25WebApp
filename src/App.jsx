...
const SEASON_DATA = {
  ...
  "Stagione 2": {
    ...
    driverPoles: {
      Alex: 1, Igor: 1, Norris: 0, Verstappen: 0, Hamilton: 0, Russell: 0,
...
const CAREER_STATS = {
  ...
  Norris:     { totalPoints: 137, totalWins: 2, totalPoles: 1, totalPodiums: 6, GrandSlam: 0, championships: 1 },
  Verstappen: { totalPoints: 83,  totalWins: 0, totalPoles: 0, totalPodiums: 4, GrandSlam: 0, championships: 0 },
  Tsunoda:    { totalPoints: 16,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Russell:    { totalPoints: 46,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Antonelli:  { totalPoints: 65,  totalWins: 1, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
  Leclerc:    { totalPoints: 46,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Hamilton:   { totalPoints: 71,  totalWins: 0, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
  ...
  Igor:       { totalPoints: 73,  totalWins: 1, totalPoles: 4, totalPodiums: 3, GrandSlam: 0, championships: 0, totalInterpole: 1 },
  Bearman:    { totalPoints: 0,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Manuel:     { totalPoints: 23,  totalWins: 0, totalPoles: 0, totalPodiums: 1, GrandSlam: 0, championships: 0, totalInterpole: 1 },
  Gasly:      { totalPoints: 1,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Alex:       { totalPoints: 118, totalWins: 4, totalPoles: 4, totalPodiums: 5, GrandSlam: 0, championships: 0, totalInterpole: 0 },
  Hulkenberg: { totalPoints: 4,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Bortoleto:  { totalPoints: 50,  totalWins: 0, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
...
const TEAM_CAREER_STATS = {
  "McLaren":          { totalPoints: 228, totalWins: 3, totalPoles: 2, championships: 1 },
  "Red Bull":         { totalPoints: 118, totalWins: 0, totalPoles: 2, championships: 0 },
  "Mercedes":         { totalPoints: 111, totalWins: 1, totalPoles: 0, championships: 0 },
  "Ferrari":          { totalPoints: 117,  totalWins: 0, totalPoles: 0, championships: 0 },
  "Williams":         { totalPoints: 58,  totalWins: 1, totalPoles: 0, championships: 0 },
  "Aston Martin":     { totalPoints: 51,  totalWins: 0, totalPoles: 0, championships: 0 },
