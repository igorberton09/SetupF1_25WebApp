...
const SEASON_DATA = {
  ...
  "Stagione 2": {
    ...
    raceExtras: [
      ...
      { race: "Olanda",    pole: null,    overtakes: null, interpole: null },
      { race: "Jeddah",    pole: null,    overtakes: null, interpole: null },
      { race: "Qatar",     pole: null,    overtakes: null, interpole: null },
    ],
    calendar: [
    ...
    driverPoles: {
      Alex: 2, Igor: 1, Norris: 0, Verstappen: 0, Hamilton: 0, Russell: 0,
  ...
  "Stagione 3": {
    ...
    raceExtras: [
      { race: "?", pole: null, overtakes: null, interpole: null },
      { race: "?", pole: null, overtakes: null, interpole: null },
      { race: "?", pole: null, overtakes: null, interpole: null },
      { race: "?", pole: null, overtakes: null, interpole: null },
      { race: "?", pole: null, overtakes: null, interpole: null },
...
const CAREER_STATS = {
  Piastri:    { totalPoints: 58,  totalWins: 0, totalPoles: 0, totalPodiums: 1, GrandSlam: 0, championships: 0 },
  Norris:     { totalPoints: 149, totalWins: 2, totalPoles: 1, totalPodiums: 6, GrandSlam: 0, championships: 1 },
  Verstappen: { totalPoints: 91,  totalWins: 0, totalPoles: 0, totalPodiums: 4, GrandSlam: 0, championships: 0 },
  Tsunoda:    { totalPoints: 16,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Russell:    { totalPoints: 50,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Antonelli:  { totalPoints: 75,  totalWins: 1, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
  Leclerc:    { totalPoints: 48,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Hamilton:   { totalPoints: 77,  totalWins: 0, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
  Albon:      { totalPoints: 19,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Sainz:      { totalPoints: 39,  totalWins: 1, totalPoles: 0, totalPodiums: 1, GrandSlam: 0, championships: 0 },
  Alonso:     { totalPoints: 49,  totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Stroll:     { totalPoints: 2,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Lawson:     { totalPoints: 2,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Igor:       { totalPoints: 92,  totalWins: 1, totalPoles: 4, totalPodiums: 4, GrandSlam: 0, championships: 0, totalInterpole: 1 },
  Bearman:    { totalPoints: 0,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Manuel:     { totalPoints: 38,  totalWins: 0, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0, totalInterpole: 1 },
  Gasly:      { totalPoints: 1,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Alex:       { totalPoints: 145, totalWins: 5, totalPoles: 5, totalPodiums: 6, GrandSlam: 1, championships: 0, totalInterpole: 1 },
  Hulkenberg: { totalPoints: 4,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Bortoleto:  { totalPoints: 51,  totalWins: 0, totalPoles: 0, totalPodiums: 2, GrandSlam: 0, championships: 0 },
  Colapinto:  { totalPoints: 8,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Ocon:       { totalPoints: 0,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
  Hadjar:     { totalPoints: 0,   totalWins: 0, totalPoles: 0, totalPodiums: 0, GrandSlam: 0, championships: 0 },
};

const TEAM_CAREER_STATS = {
  "McLaren":          { totalPoints: 262, totalWins: 4, totalPoles: 3, championships: 1 },
  "Red Bull":         { totalPoints: 144, totalWins: 0, totalPoles: 2, championships: 0 },
  "Mercedes":         { totalPoints: 125, totalWins: 1, totalPoles: 0, championships: 0 },
  "Ferrari":          { totalPoints: 125, totalWins: 0, totalPoles: 0, championships: 0 },
  "Williams":         { totalPoints: 58,  totalWins: 1, totalPoles: 0, championships: 0 },
  "Aston Martin":     { totalPoints: 66,  totalWins: 0, totalPoles: 0, championships: 0 },
  ...
  "Alpine":           { totalPoints: 84,  totalWins: 3, totalPoles: 3, championships: 0 },
  "Sauber":           { totalPoints: 55,  totalWins: 0, totalPoles: 0, championships: 0 },
};
