...
const SEASON_DATA = {
  "Stagione 1": {
    races: [
      ...
      { race: "Brasile",    results: ["Alex","Manuel","Norris","Alonso","Leclerc","Piastri","Verstappen","Antonelli","Russell","Hamilton","Gasly","Hulkenberg","Bearman","Albon","Tsunoda","Bortoleto","Lawson","Sainz","Igor","Stroll"] },
  ...
  "Stagione 3": {
    races: [
      ...
      { race: "Cina",      results: ["Igor","Alex","Antonelli","Russell","Manuel","Piastri","Tsunoda","Colapinto","Leclerc","Gasly","Bearman","Verstappen","Albon","Lawson","Hulkenberg","Ocon","Sainz","Hadjar","Bortoleto","Alonso"] },
      { race: "Giappone",  results: ["Igor","Alex","Verstappen","Piastri","Manuel","Gasly","Albon","Leclerc","Tsunoda","Russell","Colapinto","Bearman","Hulkenberg","Ocon","Lawson","Bortoleto","Antonelli","Hadjar","Alonso","Sainz"] },
      { race: "Olanda",    results: ["Igor","Alex","Manuel","Verstappen","Antonelli","Leclerc","Russell","Piastri","Tsunoda","Alonso","Gasly","Albon","Colapinto","Ocon","Bortoleto","Hulkenberg","Sainz","Bearman","Hadjar","Lawson"] },
    ],
    raceExtras: [
      ...
      { race: "Australia", pole: "Igor", overtakes: "Manuel",    fastest: "Igor",   loyal: "Igor"   },
      { race: "Cina",      pole: "Igor", overtakes: "Alex",      fastest: "Igor",   loyal: "Igor"   },
      { race: "Giappone",  pole: "Igor", overtakes: "Manuel",    fastest: "Igor",   loyal: "Alex"   },
      { race: "Olanda",    pole: "Igor", overtakes: "Antonelli", fastest: "Igor",   loyal: "Igor"   },
    ],
    calendar: [
      { round: 1, race: "Belgium GP",    city: "Spa-Francochamps", status: "done",     winner: "Igor", raceKey: "Spa"       },
      { round: 2, race: "Hungary GP",    city: "Hungaroring",      status: "done",     winner: "Igor", raceKey: "Ungheria"  },
      { round: 3, race: "Texas GP",      city: "Austin",           status: "done",     winner: "Igor", raceKey: "Austin"    },
      { round: 4, race: "Australian GP", city: "Melbourne",        status: "done",     winner: "Igor", raceKey: "Australia" },
      { round: 5, race: "Chinese GP",    city: "Shanghai",         status: "done",     winner: "Igor", raceKey: "Cina"      },
      { round: 6, race: "Japan GP",      city: "Suzuka",           status: "done",     winner: "Igor", raceKey: "Giappone"  },
  ...
  "Stagione 4": {
    races: [
      { race: "Qatar",      results: ["Alex","Igor","Russell","Hamilton","Leclerc","Antonelli","Albon","Gasly","Lindblad","Hulkenberg","Alonso","Colapinto","Bearman","Lawson","Bortoleto","Ocon","Perez","Stroll","Sainz","Verstappen","Manuel","Bottas"] },
    ...
    raceExtras: [
      { race: "Qatar",       pole: "Igor", overtakes: "Alex",  fastest: "Alex"   },
    ...
    calendar: [
      { round: 1, race: "Qatar GP",          city: "Lusail",            status: "done",     winner: "Alex", raceKey: "Qatar"  },
      { round: 2, race: "Japan GP",          city: "Suzuka",            status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 3, race: "Australian GP",     city: "Melbourne",         status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 4, race: "Saudi Arabian GP",  city: "Jeddah",            status: "upcoming",     winner: "...", raceKey: "..."  },
  ...
  "Stagione 5": {
    ...
    calendar: [
      { round: 1, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 2, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 3, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 4, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 5, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 6, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
      { round: 7, race: "?",    city: "?",   status: "upcoming",     winner: "...", raceKey: "..."  },
    ],
...
const TEAM_CHANGES = {
  ...
  "Stagione 4": {
    ...
    Lindblad:   { team: "Visa Cash App RB", num: 41 },
    Perez:      { team: "Cadillac",         num: 11 },
    Bottas:     { team: "Cadillac",         num: 77 },
    Tsunoda:    { team: "No Seat",          num: 22 },
...
const CAREER_STATS = {
  ...
  Verstappen: { totalPoints: 175, totalWins: 0, totalPoles: 0,  totalPodiums: 6,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Tsunoda:    { totalPoints: 40,  totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Russell:    { totalPoints: 128, totalWins: 0, totalPoles: 0,  totalPodiums: 1,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Antonelli:  { totalPoints: 164, totalWins: 1, totalPoles: 0,  totalPodiums: 5,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Leclerc:    { totalPoints: 107, totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Hamilton:   { totalPoints: 113, totalWins: 0, totalPoles: 0,  totalPodiums: 2,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Albon:      { totalPoints: 42,  totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Sainz:      { totalPoints: 54,  totalWins: 1, totalPoles: 0,  totalPodiums: 1,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Alonso:     { totalPoints: 61,  totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Stroll:     { totalPoints: 2,   totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Lawson:     { totalPoints: 6,   totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Igor:       { totalPoints: 328, totalWins: 8, totalPoles: 13, totalPodiums: 16, HatTrick: 4, GrandSlam: 2, championships: 1, constructorchamp: 1, totalInterpole: 1 },
  Bearman:    { totalPoints: 0,   totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Manuel:     { totalPoints: 82,  totalWins: 0, totalPoles: 0,  totalPodiums: 3,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0, totalInterpole: 1 },
  Gasly:      { totalPoints: 19,  totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
  Alex:       { totalPoints: 384, totalWins: 9, totalPoles: 7,  totalPodiums: 18, HatTrick: 0, GrandSlam: 2, championships: 1, constructorchamp: 1, totalInterpole: 3 },
  ...
  Lindblad:   { totalPoints: 2,   totalWins: 0, totalPoles: 0,  totalPodiums: 0,  HatTrick: 0, GrandSlam: 0, championships: 0, constructorchamp: 0 },
...
const TEAM_CAREER_STATS = {
  "McLaren":          { totalPoints: 657, totalWins: 14, totalPoles: 13, championships: 3, driverchamp: 3 },
  "Red Bull":         { totalPoints: 321, totalWins: 1,  totalPoles: 6,  championships: 0, driverchamp: 0 },
  "Mercedes":         { totalPoints: 302, totalWins: 1,  totalPoles: 0,  championships: 0, driverchamp: 0 },
  "Ferrari":          { totalPoints: 332, totalWins: 0,  totalPoles: 1,  championships: 0, driverchamp: 0 },
  "Williams":         { totalPoints: 85,  totalWins: 1,  totalPoles: 0,  championships: 0, driverchamp: 0 },
  "Aston Martin":     { totalPoints: 147, totalWins: 0,  totalPoles: 0,  championships: 0, driverchamp: 0 },
  "Visa Cash App RB": { totalPoints: 58,  totalWins: 1,  totalPoles: 3,  championships: 0, driverchamp: 0 },
  "Haas":             { totalPoints: 25,  totalWins: 0,  totalPoles: 0,  championships: 0, driverchamp: 0 },
  "Alpine":           { totalPoints: 140, totalWins: 3,  totalPoles: 3,  championships: 0, driverchamp: 0 },
